  ...
  <body style="background:gray;">
    <div class="row">
      ...
      <div class="col-md-3">
        <div class="card">
          ...
          <div class="card-body">
            <ul>
              <marquee direction="up" scrollamount="2"><li><a>1. Mess facality will be  provided till 4th August 2023.</a></li>
    ...
    <div class="row">
      <div class="col-md-2 m-auto">
        ...
        <a href="" type="button" class="btn btn-primary btn-block"><form><script src="https://checkout.razorpay.com/v1/payment-button.js" data-payment_button_id="pl_LI2cVDH06u1f73" async> </script> </form></a>
